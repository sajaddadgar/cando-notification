...
public class BookmarkNotificaion implements INotification {
    ...
    public void send() {
        ...
        Stream<StompPrincipal> stompPrincipalStream = notificationService.getUsernameFromEmail(email);
        stompPrincipalStream.forEach(stompPrincipal ->
        {
    ...
    private Trigger getTrigger() {
        return TriggerBuilder.
                ...
                .startAt(new Date(new Date().getTime() + 5000L))
